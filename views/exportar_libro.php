...
$pdf->Cell(60, 10, utf8_decode('Título'), 1, 0, 'L', 1);
$pdf->Cell(50, 10, 'Autor', 1, 0, 'L', 1);
$pdf->Cell(20, 10, utf8_decode('Año'), 1, 0, 'L', 1);
...
while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
    ...
    $pdf->Cell(60, 10, utf8_decode($row['titulo']), 1);
    $pdf->Cell(50, 10, utf8_decode($autorData['nombre']), 1);
